...
const messages = {
  words: [
    "Tu desempeño fue bajo en la prueba de vocabulario.",
    "Te fue bien en la prueba de vocabulario!",
    "Te fue muy bien en la prueba de vocabulario!",
  ],
  autores: [
    "Tu desempeño fue bajo en la prueba de autores.",
    "Te fue bien en la prueba de autores!",
    "Te fue muy bien en la prueba de autores!",
  ],
  comprension_lectora: [
    "Tu desempeño fue bajo en la prueba de comprensión lectora.",
    "Te fue bien en la prueba de comprensión lectora!",
    "Te fue muy bien en la prueba de comprensión lectora!",
  ],
}
...
function bars(performance, thresholds) {
  ...
  svg.setAttribute('viewBox', `0 0 100 ${bars_height}`);
...
document.addEventListener('DOMContentLoaded', (evt) => {
  ...
  get_data(`datos_resultados?sid=${sid}`).then(response => {
    response.text().then(content=> {
      ...
      _performance_words.textContent = words_message;
      ...
      _performance_autores.textContent = autores_message;
      ...
      _performance_comprension_lectora.textContent = comprension_lectora_message;
