const conditions = {
  'development': [
    {title: 'Texto 1',
      text: `    Facere autem ut saepe repellat. Et inventore possimus voluptas. Temporibus fuga nulla quia ut. Cumque ea ad commodi architecto. Ducimus aut sed ut.
  
      Dicta omnis mollitia hic architecto ea. Sunt suscipit qui labore. Rerum cumque dolor est voluptatem in sint velit. Dignissimos aut est aut quos. Vel nihil ipsa autem ratione fuga ut. Aliquam dolores consectetur qui doloremque unde dolor dolor.
  
      Dolores amet odit repudiandae voluptas molestiae. Velit aut temporibus omnis occaecati vel porro ratione dolorem. Iure ipsam labore suscipit voluptates. Voluptatem soluta reprehenderit ex est facere.
  
      Est repellat voluptatum dicta ipsum. Aspernatur numquam eaque est expedita quos facilis asperiores mollitia. Asperiores nam optio repellat voluptatum quod consequatur est. Qui repellendus laborum omnis velit temporibus voluptas veritatis. Nesciunt et non omnis exercitationem molestiae corrupti ad. Doloremque eos exercitationem sit vel rerum laboriosam quam.
...
<p>
  Tucídides atribuye al dirigente ateniense Pericles (siglo V a. C.) el siguiente discurso en honor de los soldados caídos en el primer año de la guerra del Peloponeso. 
    ...
    Tucídides, Historia de la guerra del Peloponeso (adaptación) `,
      questions: [
        {text: "<b>Pregunta 1</b><br>  Uno de los objetivos del discurso de la parte B era honrar a los soldados caídos en el primer año de la guerra del Peloponeso. <br>¿Cuál era OTRO de los objetivos de este discurso?",
          name: "pB1",
          options: [
        ...
        {text: "<b>Pregunta 2</b><br>¿Qué condenó a Tucídides al exilio?",
          name: "pB2",
          options: [
        ...
        {text: "<b>Pregunta 3</b><br>¿Quién escribió el discurso de la Parte B?",
          name: "pB3",
          options: [
        ...
        {text: "<b>Pregunta 4</b><br>Según el texto, ¿qué diferenciaba a Tucídides de los demás historiadores de su época? ",
          name: "pB4",
          options: [
        ...
        {text: "<b>Pregunta 6</b><br>La parte A de La democracia en Atenas sirve para:",
          name: "pB6",
          options: [
        ...
        {text: "<b>Pregunta 7</b><br>¿Cuál de las descripciones del estilo de Tucídides corresponde con el siguiente fragmento de Historia de la guerra del Peloponeso? <p>«Obedecemos a quienes ponemos a desempeñar cargos públicos y obedecemos las leyes, en especial las dirigidas a la protección de los oprimidos y las leyes no escritas que supone una verdadera vergüenza infringir.»</p>",
          name: "pB7",
          options: [
